...
class _UsuariosPageState extends State<UsuariosPage> {
  ...
  void _salvarUsuario() async {
    ...
    if (nome.isNotEmpty && !_baseUsuarios.containsKey(nome)) {
      setState(() {
        _baseUsuarios[nome] =
            []; // Cria um usuário com uma lista de tarefas vazia
      });
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    ), //bola com a primeira Letra do Nome do Usuário
                    title: Text(usuario),
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        ...
                        (value) => _carregarUsuarios(),
                      ); //atualiza a lista de usuários ao voltar para a página
                    },
                  );
                },
              ),
